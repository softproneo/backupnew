            ...
            <form action="{{ route('tax.store') }}" method="post" id="addTaxClass"
                ...
                <div class="modal-footer py-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <button type="submit"
                                class="btn py-2 custom-btn-submit ltr:float-right rtl:float-left tax-class-submit">{{ __('Save') }}</button>
                            <button type="button" class="py-2 custom-btn-cancel ltr:float-right ltr:me-2 rtl:float-left rtl:ms-2"
