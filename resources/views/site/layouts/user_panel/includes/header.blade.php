<div class="px-4 md:px-8 py-2 h-74p md:sticky top-0 flex ltr:md:justify-between rtl:justify-between relative items-center shadow-sm bg-gray-12 dark:bg-red-2 z-50">
    <div class="flex flex-wrap items-center w-2/3 rtl:md:order-1 rtl:order-2 rtl:justify-between rtl:md:justify-start">
        <div class="p-2 rounded-full hover:bg-gray-200 cursor-pointer md:hidden rtl:order-1" @click="sidemenu = !sidemenu">
        ...
        @if ($headerMobileLogo->objectFile)
            <div class="md:hidden ltr:ml-3 rtl:mr-auto">
                <img class="w-36 h-11 object-contain neg-transition-scale" src="{{ $headerMobileLogo->fileUrl() }}" alt="{{ __('Image') }}">
            </div>
        @endif
        <div class="flex right-5 absolute md:relative flex-col justify-center cursor-pointer ltr:ml-2 ltr:md:ml-4 ltr:lg:ml-0 ltr:xl:ml-16 rtl:mr-2 rtl:md:mr-4">
            <a class="flex" href="{{ route('site.index') }}" target="_blank">
                ...
                <span
                    class="dm-sans hidden lg:block font-medium whitespace-nowrap text-white ltr:ml-10p rtl:mr-10p">{{ __('Visit Site') }}</span>
            </a>
        </div>
        @if (auth()->user()->role()->slug == 'super-admin')
            <div class="flex absolute md:right-5 right-32 md:relative flex-col justify-center cursor-pointer ltr:ml-2 ltr:md:ml-4 ltr:lg:ml-5 ltr:xl:ml-16 rtl:mr-2 rtl:md:mr-4 rtl:lg:mr-5 rtl:xl:mr-16">
                <a class="flex" href="{{ route('dashboard') }}" target="_blank">
                    ...
                    <span
                        class="dm-sans hidden lg:block font-medium whitespace-nowrap text-white ltr:ml-10p rtl:mr-10p">{{ __('Admin Panel') }}</span>
                </a>
            </div>
        @endif
        @if (auth()->user()->role()->slug == 'super-admin' ||
            ...
            <div
                ...
                <a class="flex" href="{{ route('vendor-dashboard') }}" target="_blank">
                    ...
                    <span
                        class="dm-sans hidden lg:block font-medium whitespace-nowrap text-white ltr:ml-10p rtl:mr-10p">{{ __('Vendor Panel') }}</span>
                </a>
            </div>
        @endif
        ...
        @impersonated
            <div class="flex flex-col justify-center cursor-pointer ltr:ml-11 rtl:mr-11">
                <a class="flex" href="{{ route('impersonator-cancel') }}">
                    ...
                    <span class="dm-sans font-medium text-white ltr:ml-10p rtl:mr-10p">{{ __('Go back to admin') }}</span>
                </a>
            </div>
        @endimpersonated
    </div>
    <div class="flex items-center rtl:md:order-2 rtl:order-1">
        <div class='display-none flex flex-col ltr:md:mr-3 rtl:md:ml-3 ltr:lg:mr-4 rtl:lg:ml-4 ltr:2xl:mr-10 rtl:2xl:ml-10 ltr:mr-10 rtl:mr-10 absolute md:relative ltr:right-3.5 md:rtl:left-3.5'>
            <div class="flex items-center ltr:md:border-r rtl:md:border-l border-gray-10 notific-toggle cursor-pointer">
                <span class="ltr:mr-2 rtl:mr-2 md:rtl:ml-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11.6845 0.473621C10.9235 0.167641 10.0942 0 9.22916 0C5.8731 0 3.05373 2.52345 2.68312 5.85899L2.43132 8.1252L2.42527 8.17925C2.31244 9.16248 1.9924 10.1106 1.48627 10.9611L1.45832 11.0077L0.880287 11.9711L0.856139 12.0114C0.614615 12.4138 0.395801 12.7785 0.250048 13.0879C0.101929 13.4024 -0.0564418 13.8286 0.0197902 14.3117C0.0951394 14.7893 0.340917 15.2233 0.711642 15.5337C1.08671 15.8476 1.53359 15.931 1.87948 15.9658C2.21985 16.0001 2.6451 16 3.11449 16L3.16139 16H15.2969L15.3438 16C15.8132 16 16.2385 16.0001 16.5788 15.9658C16.9247 15.931 17.3716 15.8476 17.7467 15.5337C18.1174 15.2233 18.3632 14.7893 18.4385 14.3117C18.5148 13.8286 18.3564 13.4024 18.2083 13.0879C18.0625 12.7785 17.8437 12.4138 17.6022 12.0114L17.578 11.9711L17 11.0077L16.9721 10.9611C16.5933 10.3247 16.3188 9.63358 16.1573 8.91402C15.8565 8.97047 15.5463 9 15.2292 9C14.8452 9 14.4713 8.95672 14.1122 8.87477C14.2968 9.97147 14.6832 11.0259 15.2534 11.9839L15.285 12.0367L15.863 13.0001C16.1365 13.456 16.3014 13.733 16.3989 13.9401C16.4042 13.9514 16.4091 13.9621 16.4136 13.972C16.4027 13.9733 16.3911 13.9746 16.3786 13.9759C16.1509 13.9988 15.8285 14 15.2969 14H3.16139C2.6298 14 2.30742 13.9988 2.07968 13.9759C2.06722 13.9746 2.05558 13.9733 2.04471 13.972C2.0492 13.9621 2.05409 13.9514 2.05942 13.9401C2.15695 13.733 2.32177 13.456 2.59527 13.0001L3.17331 12.0367L3.20494 11.9839C3.85568 10.8904 4.26716 9.67142 4.41223 8.40726L4.41908 8.34607L4.67089 6.07985C4.92896 3.75718 6.8922 2 9.22916 2C9.69218 2 10.1405 2.06898 10.5639 2.19767C10.8158 1.54594 11.2004 0.960226 11.6845 0.473621ZM14.2113 2.27804C13.6233 2.62632 13.2292 3.26713 13.2292 4C13.2292 4.14503 13.2446 4.28645 13.2739 4.42272C13.3943 4.6476 13.4967 4.88404 13.5789 5.13021C13.9393 5.65547 14.544 6 15.2292 6C15.421 6 15.6066 5.97298 15.7823 5.92254L15.7752 5.85899C15.623 4.48875 15.0575 3.25555 14.2113 2.27804Z"
                            fill="white" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11.8104 18.7259C11.1401 19.4975 10.2396 20 9.22925 20C8.21894 20 7.31844 19.4975 6.64808 18.7259C5.98242 17.9598 5.54286 16.9367 5.34706 15.8405C5.24994 15.2969 5.61195 14.7774 6.15562 14.6803C6.6993 14.5831 7.21877 14.9452 7.31589 15.4888C7.46194 16.3064 7.77565 16.9743 8.15785 17.4142C8.53535 17.8487 8.91876 18 9.22925 18C9.53974 18 9.92315 17.8487 10.3006 17.4142C10.6829 16.9743 10.9966 16.3064 11.1426 15.4888C11.2397 14.9452 11.7592 14.5832 12.3029 14.6803C12.8466 14.7774 13.2086 15.2969 13.1114 15.8405C12.9156 16.9367 12.4761 17.9598 11.8104 18.7259Z"
                            fill="white" />
                        <path
                            d="M17.2292 4C17.2292 5.10457 16.3338 6 15.2292 6C14.1247 6 13.2292 5.10457 13.2292 4C13.2292 2.89543 14.1247 2 15.2292 2C16.3338 2 17.2292 2.89543 17.2292 4Z"fill="#FCCA19" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M18.2292 4C18.2292 5.65685 16.8861 7 15.2292 7C13.5724 7 12.2292 5.65685 12.2292 4C12.2292 2.34315 13.5724 1 15.2292 1C16.8861 1 18.2292 2.34315 18.2292 4ZM15.2292 6C16.3338 6 17.2292 5.10457 17.2292 4C17.2292 2.89543 16.3338 2 15.2292 2C14.1247 2 13.2292 2.89543 13.2292 4C13.2292 5.10457 14.1247 6 15.2292 6Z"
                            fill="#FCCA19" />
                    </svg>
                </span>
                <span class="text-white hidden lg:block dm-sans font-medium ltr:mr-3 rtl:ml-3">12</span>
                <span class="ltr:pr-6 rtl:pl-6 hidden lg:block">
            ...
            <div class="notific-contnet ltr:w-[310px] rtl:w-[287px] ltr:sm:w-[348px] rtl:sm:w-[348px] z-50 absolute ltr:right-[-35px] ltr:sm:right-[19px] ltr:md:right-[-58px] ltr:lg:right-[19px] rtl:md:left-[-58px] rtl:lg:left-[19px] mt-8">
                <div class="flex items-center justify-between gap-2 font-medium py-[14px] px-5">
                    <p class="text-[16px] text-[#141414]">{{ __('Notifications') }}</p>
                    <a href="javascript:void(0)" class="text-[12px] text-[#2c2c2c] underline">{{ __('Mark all as read') }}</a>
                </div>
                <ul>
                    {{-- unread notification --}}
                    <li class="border-l-[3px] border-l-[#898989] bg-[#F3F3F3]">
                        <a class="block pt-[15px] pb-[14px] mx-[13px] border-b border-b-[#DFDFDF]">
                            <span class="flex gap-[13px]">
                                 <span class="block w-[98px] rounded-full">
                                    <img class="w-[30px] h-[30px]" src="{{ asset('public/frontend/assets/img/notification/unsplash.png') }}" alt="{{ __('Image') }}" />
                                 </span>
                                 <span class="block">
                                    <span class="text-[12px] text-[#2C2C2C] leading-[16px] font-medium block">                                    
                                        NEW UPDATE! We are really excited to announce that our app version of multi-vendor will be launched on 1 Feb, 2022. Stay tuned.
                                    </span>
                                    <span class="text-[10px] text-[#898989] leading-[16px] font-medium mt-[7px] block" >2 hours ago</span>
                                 </span>
                            </span>
                        </a>
                    </li>
                ...
                <div class="flex justify-center items-center py-3 underline">
                    <a href="javascript:void(0)" class="text-[12px] text-[#2c2c2c] leading-normal">{{ __('Sell All') }}</a>
                </div>
            </div>
            <!-- notification menu end -->
        </div>
        <div class="relative hidden md:block" x-data="{ open: false }" x-cloak>
            <div @click="open = !open" class="flex items-center cursor-pointer ltr:-ml-4 rtl:-mr-4">
                <span class="ltr:mr-2.5 rtl:ml-2.5">
                ...
                <span
                    class="text-white dm-sans text-base xl:text-sm overflow-hidden whitespace-nowrap font-medium ltr:mr-3 rtl:ml-3">
                    {{ auth()->user()->name }}
                </span>
                <span class="-mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6"
            ...
            <div x-show.transition="open" @click.away="open = false"
                class="absolute mt-2 text-gray-10 bg-white border border-gray-2 shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700 z-40 ltr:right-0 rtl:left-0">
                <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                    x-transition:leave-end="opacity-0" @click.away="closeProfileMenu"
                    @keydown.escape="closeProfileMenu"
                    class="absolute w-168 text-gray-10 bg-white border border-gray-100 rounded shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2 ltr:right-0 rtl:left-0"
                    aria-label="submenu">
                    <li class="flex text-gray-10">
                        <a href="{{ route('site.userProfile') }}"
                            ...
                            href="#">
                            <svg class="ltr:ml-3.5 rtl:mr-3.5" xmlns="http://www.w3.org/2000/svg" width="14" height="15"
                            ...
                            <span class="ltr:ml-2 rtl:mr-2">{{ __('My Profile') }}</span>
                        </a>
                    </li>
                    <li class="flex text-gray-10">
                        <a href="{{ route('site.userActivity') }}" class="inline-flex text-gray-10 py-3.5 items-center w-full dm-sans font-medium text-sm transition-colors duration-150 hover:bg-gray-11 hover:text-gray-12 dark:hover:bg-gray-800 dark:hover:text-gray-200 dark:bg-hover dark:text-hover">
                            <svg class="ltr:ml-3.5 rtl:mr-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                            <span class="ltr:ml-2 rtl:mr-2">{{ __('Login Activities') }}</span>
                        </a>
                    </li>
                    <li class="flex text-gray-10">
                        <a href="{{ route('site.userSetting') }}"
                            ...
                            <svg class="ltr:ml-3.5 rtl:mr-3.5 neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                            ...
                            <span class="ltr:ml-2 rtl:mr-2">{{ __('Account Settings') }}</span>
                        </a>
                    </li>
                    <li class="flex text-gray-10">
                        <a href="{{ route('site.logout') }}"
                            ...
                            <span class="ltr:ml-2 rtl:mr-2">{{ __('Sign Out') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
