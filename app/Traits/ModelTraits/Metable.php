...
trait Metable
{
    ...
    {
        if (empty(self::$_columnNames)) {
            self::$_columnNames = array_map('strtolower', \Schema::connection($this->getConnectionName())->getColumnListing($this->getTable()));
        }
